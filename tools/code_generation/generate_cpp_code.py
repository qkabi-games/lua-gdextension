...
def generate_enums(global_enums):
    lines = [
        "// This file was automatically generated by generate_cpp_code.py",
        "static void register_global_enums(sol::state_view &state, luagdextension::LuaSandboxConfig *config) {",
    ]
    for enum in global_enums:
        enum_name = enum['name']
        lines.append(f"\t// {enum_name}")
        lines.append(f"\tif (!config || !config->is_enum_blocked(\"{enum_name}\")) {{")
